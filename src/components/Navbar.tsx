...
const Navbar: React.FC<NavbarProps> = () => {
  ...
  const menuItemVariants: Variants = {
    ...
    visible: (i: number) => ({
      ...
      opacity: 1,
      transition: {
        delay: 0.1 + i * 0.08, // Faster stagger for smoother feel
        duration: 0.4,
        ease: "easeOut",
      },
    }),
    ...
    <>
      ...
      >
                ...
                (item, index) => (
                  ...
                  >
                    <Link
                      ...
                      className="geist text-[16px] leading-[100%] text-white hover:text-white/60 transition-colors"
                    >
                      {item}
                    </Link>
                  </motion.li>
        ...
        <div className="w-full flex justify-end">
          <motion.button
            className="geist bg-white hover:bg-white/50 py-3 px-6 rounded-full text-[16px] font-bold leading-[100%] text-[#050505] md:block hidden transition-colors origin-left duration-300 cursor-pointer"
        ...
        {dropDownOpen && (
          ...
          >
            <div className="flex flex-col h-full justify-between p-4">
              ...
              <motion.button
                className="geist bg-white hover:bg-white/50 py-3 px-6 rounded-full text-base font-bold text-black transition-colors duration-300 mx-auto origin-left"
                variants={buttonVariants}
                whileHover="hover"
                whileTap="tap"
                initial={{ y: 20, opacity: 0 }}
