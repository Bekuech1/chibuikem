  ...
  return (
    <footer className="w-full h-fit flex flex-col px-6 py-5 justify-center items-center gap-[56px] bg-[#3F1BCF]" id="contact">
      ...
      <section className="w-full h-[80px] bg-[#040404] flex items-center gap-[29px] md:pl-16 pl-6">
        <a href="http://">
          <div className="flex size-fit items-center gap-2 group">
            <p className="berlin-sans text-[16px] font-normal leading-tight text-white uppercase group-hover:text-[white]/50 transition-colors">
              github
            </p>
            <img src="/arrow-white.svg" alt="" className="size-[18px] group-hover:opacity-0 transition-opacity" />
          </div>
        </a>
        <a href="http://">
          <div className="flex size-fit items-center gap-2 group">
